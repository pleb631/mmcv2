...
from mmcv2.utils import build_from_cfg, is_list_of
...
class DefaultOptimizerConstructor:
    ...
    - ``bias_lr_mult`` (float): It will be multiplied to the learning
      rate for all bias parameters except those in normalization layers.
    ...
    def __init__(self, optimizer_cfg: dict, paramwise_cfg: dict | None = None):
    ...
    def add_params(
        ...
        for name, param in module.named_parameters(recurse=False):
            ...
            if not is_custom:
                ...
                # except for normalization layer biases
