...
class Registry:
    ...
    def infer_scope():
        ...
        infer_scope_caller = cast(FrameType, frame.f_back).f_back
        module = cast(ModuleType, inspect.getmodule(infer_scope_caller))
    ...
    def module_dict(self):
        """Return the mapping of registered names to objects."""
    ...
    def get(self, key):
        ...
        if scope is None or scope == self._scope:
            ...
            if scope in self._children:
                ...
                # goto root
                parent = cast(Registry, self.parent)
                while parent.parent is not None:
                    parent = parent.parent
                return parent.get(key)

    def build(self, *args, **kwargs):
        """Build an object using this registry's build function."""
