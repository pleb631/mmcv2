...
import pytest
import torch
from mmcv2.cnn.utils.weight_init import update_init_info
from mmcv2.runner import BaseModule, ModuleDict, ModuleList, Sequential
from mmcv2.utils import Registry, build_from_cfg
...
def test_initilization_info_logger():
    ...
    from mmcv2.utils.logging import get_logger
    from torch import nn
    ...
    init_cfg = [
        ...
        {"type": "Constant", "layer": "Linear", "val": 0.0, "bias": 1.0},
    ]
    ...
    lines = mmcv2.list_from_file(log_file)
...
def test_model_weight_init():
    ...
    model_cfg = {
        ...
        "component1": {"type": "FooConv1d"},
        "component2": {"type": "FooConv2d"},
        "component3": {"type": "FooLinear"},
        "component4": {
            "type": "FooLinearConv1d",
            "linear": {"type": "FooLinear"},
            "conv1d": {"type": "FooConv1d"},
        },
    }
    ...
    assert torch.equal(
        model.component2.conv2d.weight,
        torch.full(model.component2.conv2d.weight.shape, 5.0),
    )
    assert torch.equal(
        model.component2.conv2d.bias,
...
def test_nest_components_weight_init():
    ...
    model_cfg = {
        ...
        "init_cfg": [
            {
                ...
                "bias": 2,
                "layer": "Linear",
                "override": {"type": "Constant", "name": "reg", "val": 13, "bias": 14},
            },
            {"type": "Constant", "val": 3, "bias": 4, "layer": "Conv1d"},
            {"type": "Constant", "val": 5, "bias": 6, "layer": "Conv2d"},
        ],
        "component1": {
            "type": "FooConv1d",
            "init_cfg": {"type": "Constant", "layer": "Conv1d", "val": 7, "bias": 8},
        },
        "component2": {
            "type": "FooConv2d",
            "init_cfg": {"type": "Constant", "layer": "Conv2d", "val": 9, "bias": 10},
        },
        "component3": {"type": "FooLinear"},
        "component4": {
            "type": "FooLinearConv1d",
...
def test_without_layer_weight_init():
    model_cfg = {
        ...
        "component1": {
            "type": "FooConv1d",
            "init_cfg": {"type": "Constant", "val": 7, "bias": 8},
        },
        "component2": {"type": "FooConv2d"},
        "component3": {"type": "FooLinear"},
    }
...
def test_override_weight_init():
    ...
    model_cfg = {
        "type": "FooModel",
        "init_cfg": [{"type": "Constant", "val": 10, "bias": 20, "override": {"name": "reg"}}],
        "component1": {"type": "FooConv1d"},
        "component3": {"type": "FooLinear"},
    }
    model = build_from_cfg(model_cfg, FOOMODELS)
        ...
        "init_cfg": [
            {
                ...
                "val": 1,
                "bias": 2,
                "override": {"name": "reg", "type": "Constant", "val": 30, "bias": 40},
            }
        ],
        "component1": {"type": "FooConv1d"},
        "component2": {"type": "FooConv2d"},
