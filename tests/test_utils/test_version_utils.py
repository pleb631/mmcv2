...
import pytest
from mmcv2 import get_git_hash, parse_version_info
from mmcv2.utils import digit_version
...
def test_get_git_hash():
    with patch("mmcv2.utils.version_utils._minimal_ext_cmd", _mock_cmd_success):
    ...
    with patch("mmcv2.utils.version_utils._minimal_ext_cmd", _mock_cmd_fail):
