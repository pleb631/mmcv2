import pytest
import torch
from mmcv2.cnn import NonLocal1d, NonLocal2d, NonLocal3d
from mmcv2.cnn.bricks.non_local import _NonLocalNd
...
def test_nonlocal3d():
    ...
    if torch.__version__ == "parrots" and torch.cuda.is_available():
